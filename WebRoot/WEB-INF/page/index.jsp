...
<head>
	...
	<script type="text/javascript" charset="utf-8">
		function init() {
			...
			scheduler.load("/load");  
			scheduler.parse([
				{ start_date: "2015-04-18 09:00", end_date: "2015-04-18 12:00", text:"English lesson", subject: 'math' },
				{ start_date: "2015-04-20 10:00", end_date: "2015-04-21 16:00", text:"Math exam", subject: 'math' },
				{ start_date: "2015-04-21 10:00", end_date: "2015-04-21 14:00", text:"Science lesson", subject: 'math' },
			...
			scheduler.attachEvent("onEventAdded", function(event_id,event_object){  
                ...
                $.ajax({  
	                type: 'post',  
	                url: "/add", 
	                data: "stime="+sdatestr+"&etime="+edatestr+"&eid="+event_id+"&title="+event_object.text+"", 
